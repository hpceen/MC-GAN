...
#echo "TRAIN MODEL WITH REAL TRAINING DATA" 
 ...
 #python2.7 train_Stack.py --dataroot ${DATASET}  --name ${NAME} --model ${MODEL} \
							  ...
							  #--display_freq 5 --print_freq 5 --blanks 0 --conv3d --base_font --base_root ${base_dir} --gpu_ids ' '
...
python2.7 train_Stack.py --dataroot ${DATASET}  --name ${NAME} --model ${MODEL} \
                                ...
                                --lambda_C ${LAM_C} --align_data --use_dropout --display_id 0 --niter ${NITER} --niter_decay ${NITERD} \
                                --batchSize ${BATCHSIZE} --conditional --save_epoch_freq 100 --rgb_out --partial --which_epoch ${EPOCH} \
                                --display_freq 5 --print_freq 5 --blanks 0 --base_font --conv3d --no_Style2Glyph --base_root ${base_dir} --orna --gpu_ids ' '
