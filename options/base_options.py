...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--base_font', action='store_false', help='use a base font for using in the conditional GAN')
        self.parser.add_argument('--base_root', default='./dataset/russian_fonts/BASE', help='path to a base font : a simple grayscale font image containing all 26 glyphs')
